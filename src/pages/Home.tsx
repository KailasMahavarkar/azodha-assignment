...
const Home = () => {
    ...
    const { personalInfo, favoriteSongs } = useAppSelector((state) => state.onboarding);
                    ...
                    <div className="relative px-4 py-10 bg-base-100 shadow-xl rounded-2xl sm:rounded-3xl sm:p-10 relative">
                        <div className="max-w-md mx-auto space-y-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-3 pl-2">
                                    ...
                                    <div className="flex justify-between items-center border-b border-base-200 pb-2">
                                        ...
                                        <span className="font-semibold text-gray-900">{personalInfo.age}</span>
                                    </div>
                                    <div className="flex justify-between items-center border-b border-base-200 pb-2">
                            ...
                            <div className="alert alert-success bg-green-50 text-green-800 border-green-200">
                                ...
                                <span className="text-xs">Payment info saved locally (Demo).</span>
                            </div>

                        </div>

                        <div className='mt-4 flex items-center justify-center'>
                            <div className='btn btn-error btn-sm gap-2' onClick={handleLogout}>
                                logout
                            </div>
                        </div>
                    </div>
