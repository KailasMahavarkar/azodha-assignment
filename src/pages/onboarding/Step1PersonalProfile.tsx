...
import { setPersonalInfo, setCurrentStep } from '../../store/slices/onboardingSlice';
...
const Step1PersonalProfile = () => {
    ...
    return (
        ...
        >
            ...
            <form id="personal-profile-form" onSubmit={formik.handleSubmit} className="space-y-6">
                <div className="form-control">
                    <div className="flex flex-col sm:flex-row gap-2">
                        <label className="label sm:w-32 sm:justify-start sm:pt-2 p-0 pb-1 sm:pb-0" htmlFor="name">
                        ...
                        <div className="flex-1">
                            ...
                            {formik.touched.name && formik.errors.name && (
                                <label className="label p-0 pt-1">
                                    <span className="label-text-alt text-error">{formik.errors.name as string}</span>
                                </label>
                            )}
                        </div>
                    </div>
                ...
                <div className="form-control">
                    <div className="flex flex-col sm:flex-row gap-2">
                        <label className="label sm:w-32 sm:justify-start sm:pt-2 p-0 pb-1 sm:pb-0" htmlFor="age">
                        ...
                        <div className="flex-1">
                            <input
                                ...
                                className={`input input-bordered w-full ${formik.touched.age && formik.errors.age ? 'input-error' : ''
                                    }`}
                            />
                            {formik.touched.age && formik.errors.age && (
                                <label className="label p-0 pt-1">
                                    <span className="label-text-alt text-error">{formik.errors.age as string}</span>
                                </label>
                            )}
                        </div>
                    </div>
                ...
                <div className="form-control">
                    <div className="flex flex-col sm:flex-row gap-2">
                        <label className="label sm:w-32 sm:justify-start sm:pt-2 p-0 pb-1 sm:pb-0" htmlFor="email">
                        ...
                        <div className="flex-1">
                            ...
                            {formik.touched.email && formik.errors.email && (
                                <label className="label p-0 pt-1">
                                    <span className="label-text-alt text-error">{formik.errors.email as string}</span>
                                </label>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <label htmlFor="profilePicture" className="btn btn-outline btn-sm">
                                        <svg
                                    ...
                                    <input
                                        ...
                                        className="hidden"
                                    />
                                    <div className="text-xs text-base-content/60 mt-1">PNG, JPG up to 10MB</div>
                                </div>
                            </div>
                        </div>
                    </div>
